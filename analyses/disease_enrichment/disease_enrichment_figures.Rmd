...
# ggsave(filename = "figures/case_study/pval_histogram.png", 
#        plot = p_hist_plot, device = "png", width=5, height=5)
```
...
ggsave(filename = "paper/figures/Figure5/Figure5b.png", 
       plot = volcano_plot, device = "png", width=5, height=10)
```
